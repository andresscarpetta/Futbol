Rails.application.routes.draw do
  ...
  devise_for :players, path: 'auth', path_names: { sign_in: 'login', sign_out: 'logout', password: 'secret', confirmation: 'verification', unlock: 'unblock', registration: 'register', sign_up: 'cmon_let_me_in' }, module: "players", :controllers => { :omniauth_callbacks => "players/omniauth_callbacks" }
  root to: "home#index"
